...
import { idlFactory } from './fuel-dao-frontend-rs.did.js';
export { idlFactory } from './fuel-dao-frontend-rs.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUEL_DAO_FRONTEND_RS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fuel-dao-frontend-rs.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fuel-dao-frontend-rs canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fuel-dao-frontend-rs.did.js")._SERVICE>}
 */
export const fuel_dao_frontend_rs = createActor(canisterId);
